        ...
        <div className="flex items-center gap-3.5">
          ...
          <div>
            ...
            <h1 className="text-xl md:text-2xl font-black text-slate-900">
              مركز الربط السحابي وتوليد أكواد وباركود الأدوار الثلاثة (المدرس • الطالب • المدير)
            </h1>
            <p className="text-xs text-slate-600 font-bold mt-0.5">
              امسح رمز الباركود QR من تطبيق الأستاذ، تطبيق الطالب، أو تطبيق المدير للربط اللحظي ومزامنة البيانات سحابياً.
            </p>
          </div>
        </div>
